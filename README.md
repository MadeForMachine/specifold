...
The same folder works in both Claude Code and Codex — clone this repo (or copy the
skill folder) into a skills directory:

**Claude Code**

```sh
git clone https://github.com/MadeForMachine/specifold.git ~/.claude/skills/specifold
# or, scoped to one repository:
git clone https://github.com/MadeForMachine/specifold.git <repo>/.claude/skills/specifold
```

**Codex**

```sh
git clone https://github.com/MadeForMachine/specifold.git ~/.agents/skills/specifold
# or, scoped to one repository:
git clone https://github.com/MadeForMachine/specifold.git <repo>/.agents/skills/specifold
```
